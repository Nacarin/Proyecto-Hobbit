...
export class EscenaGundam2 extends EscenaGundam {
    ...
    decision(){
        ...
        let escenaElegida = super.confirmacion("¿Acompañas a Amuro a la White Base?")
        //Si aceptas va a una opción si cancelas a la otra
        if(escenaElegida){
            let escena3a = new EscenaGundam3a(this.aventura, this.aventuraGundam);
            escena3a.iniciarEscena();
        } 
        else{
            let escena3b = new EscenaGundam3b(this.aventura, this.aventuraGundam);
