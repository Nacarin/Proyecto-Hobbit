...
export class EscenaGundam3a extends EscenaGundam {
    ...
    decision(){
        ...
        let escenaElegida = super.hacerPregunta("Deseas huir robándo el gundam en el proceso (huir) o aceptar el destino e ir al calabozo (destino)")
        ...
        switch (escenaElegida) {
            case 'huir':  
                let escenaGundam4aa = new EscenaGundam4aa(this.aventura,this.aventuraGundam);
                escenaGundam4aa.iniciarEscena();
                break;
            case 'destino':  
                let escenaGundam4ab = new EscenaGundam4ab(this.aventura,this.aventuraGundam);
